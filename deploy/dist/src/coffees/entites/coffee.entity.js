...
let Coffee = class Coffee {
    static _OPENAPI_METADATA_FACTORY() {
        return { id: { required: true, type: () => Number }, name: { required: true, type: () => String }, brand: { required: true, type: () => String }, recommendations: { required: true, type: () => Number }, flavors: { required: true, type: () => [require("./flavor.entity").Flavor] } };
    }
};
